...
trait MockService[F[_]] extends Service[F] {
  ...
  //val service2HistoryRef: Ref[F, Chain[(String, Either[Throwable, (String], Int))]] //generated by macro to be able to get service2 method call history
  //def whenService2(mock: String => F[(String, Int)]): F[Unit] //generated by macro to be able to add method behaviour for service2
  override def service2(i: String): F[(String, Int)] //Needs to be added even though inherited from the parent since it is hard for an annotation marco to explore parent Tree
...
object MockServiceManual {
  def apply(): IO[MockService[IO]] =
    for {
      ...
      defaultService2HistoryRef <- Ref.of[IO, Chain[(String, Either[Throwable, (String, Int)])]](Chain.empty)
      ...
      service2MockRef           <- Ref.of[IO, String => IO[(String, Int)]](defaultService2Mock)
      ...
      override val service2HistoryRef: Ref[IO, Chain[(String, Either[Throwable, (String, Int)])]] = defaultService2HistoryRef
      ...
      override def service2(i: String): IO[(String, Int)] =
        service2MockRef.get
          .flatMap(_.apply(i))
          .attempt
      ...
      override def whenService2(mockF: String => IO[(String, Int)]): IO[Unit] = service2MockRef.set(mockF)
